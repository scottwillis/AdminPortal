...
namespace Common {
	...
	public class ModalDialogService : IDialogService {
		...
		static MessageBoxButton GetButton(DialogResult button) {
			switch (button) {
				case DialogResult.OK: return MessageBoxButton.OK;
				case DialogResult.OKCancel: return MessageBoxButton.OKCancel;
				case DialogResult.YesNo: return MessageBoxButton.YesNo;
				case DialogResult.YesNoCancel: return MessageBoxButton.YesNoCancel;
			}
